...
<body>
    <table style="position:absolute;" width="100%" height="90%" border="0" cellpadding="5" cellspacing="0">
        <form action="${ctx}/addStudent" id="studentForm" method="post">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="10">
                ...
                <tr style="font-size:19px;">
                    <td style="position:absolute;top:10%;left:12%">学（工）号：<input type="text" name="cardid" id="cardid"
                            value="${student.cardid }" size="20" /></td>
                    <td style="position:absolute;top:10%;left:40%">姓名：<input type="text" name="stname" id="stname"
                            value="${student.stname }" size="20" /></td>
                    <c:if test="${not empty property.property1}">
                        <td style="position:absolute;top:10%;left:72%">${property.property1}：<input type="text" name="param1"
                ...
                <tr style="font-size:19px;">
                    <c:if test="${not empty property.property2}">
                        <td style="position:absolute;top:15%;left:12%">${property.property2}：<input type="text" name="param2"
                                id="param2" value="${student.param2 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property3}">
                        <td style="position:absolute;top:15%;left:39%">${property.property3}：<input type="text" name="param3"
                                id="param3" value="${student.param3 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property4}">
                        <td style="position:absolute;top:15%;left:72%">${property.property4}：<input type="text" name="param4"
                ...
                <tr style="font-size:19px;">
                    <c:if test="${not empty property.property5}">
                        <td style="position:absolute;top:20%;left:12%">${property.property5}：<input type="text" name="param5"
                                id="param5" value="${student.param5 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property6}">
                        <td style="position:absolute;top:20%;left:39%">${property.property6}：<input type="text" name="param6"
                                id="param6" value="${student.param6 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property7}">
                        <td style="position:absolute;top:20%;left:72%">${property.property7}：<input type="text" name="param7"
                ...
                <tr style="font-size:19px;">
                    <c:if test="${not empty property.property8}">
                        <td style="position:absolute;top:15%;left:12%">${property.property8}：<input type="text" name="param8"
                                id="param8" value="${student.param8 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property9}">
                        <td style="position:absolute;top:15%;left:39%">${property.property9}：<input type="text" name="param9"
                                id="param9" value="${student.param9 }" size="20" /></td>
                    </c:if>
                    <c:if test="${not empty property.property10}">
                        <td style="position:absolute;top:15%;left:39%">${property.property10}：<input type="text" name="param10"
        ...
        <form action="${ctx}/upload?flag=basic" method="post" enctype="multipart/form-data">
            <p style="position:absolute;top:35%;left:12%;font-size:24px;color:#1262b3;">智能添加</p>
