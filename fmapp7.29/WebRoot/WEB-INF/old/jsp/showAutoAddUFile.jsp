...
<body>
    ...
    <table style="position:absolute;" width="100%" height="90%" border="0" cellpadding="5" cellspacing="0">
        <form action="${ctx}/upload?flag=u&cardid=${cardid }" id="studentForm" method="post">
...
<!--             <tr>
        ...
        <form action="${ctx}/upload?flag=u&cardid=${cardid }" method="post" enctype="multipart/form-data">
