...
<table class="toptable"  style="left:10%" width="100%" height="100%" border="0" cellpadding="5" cellspacing="0">
			  ...
			  <td>
			  	<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/selectStudent">
				    <table width="80%" border="0" cellpadding="0" >
					  <tr>
					    	<td style="position:absolute;left:172px;top:60px;">姓名：<input type="text" name="stname"></td>
					    	<td style="position:absolute;left:592px;top:60px;">学号：<input type="text" name="cardid"></td>
					  </tr>
					  <tr>
					    <td style="position:absolute;left:172px;top:90px;">班级：<input type="text" name="clazzname"></td>
					    <td style="position:absolute;left:555px;top:90px;">所属党支部：<input type="text" name="party"></td>
					    <td style="position:absolute;left:935px;top:90px;">
					    	<input type="submit" value="搜索"/>
					    	<input id="delete" type="button" value="删除"/>
					    </td>
					    
					    <td style="position:absolute;left:1100px;top:90px;>
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table  style="font-size:12px;position:absolute;top:150px;left:100px;  border:#c2c6cc 1px solid; border-collapse:collapse;" width="90%" border="1" cellpadding="5" cellspacing="0" align="center">
		    <tr align="center">
			  ...
			  <td>所属党支部</td>
			  <td>档案位置</td>
			  <td colspan="3" align="center" width="30%">操作</td>
			</tr>
	  ...
	  <!-- 分页标签 -->
	  <tr valign="top"><td align="center" style="position:absolute;right:96px;top:70px;">
	  	 <fkjava:pager
