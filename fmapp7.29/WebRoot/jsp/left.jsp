		...
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  ...
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/addStudentFromImageForm" target="main">智能添加学生</a></img></p>
			  <%-- <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/addFileFromImageForm" target="main">添加档案</a></img></p> --%>
		  ...
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  ...
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/selectVisitorForm" target="main">借阅记录查询</a></img></p>
			   <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/selectDate" target="main">借阅超期提醒</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  
		  <tr><td id="navbg2" class="left_nav_closed" ><div class="font1">统计分析</div></td></tr>
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="25">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/chartsForm" target="main">统计分析</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
		  
		  <%-- <tr><td id="navbg2" class="left_nav_closed" ><div class="font1">智能管理</div></td></tr>
		  <tr valign="top">
		    <td class="left_nav_bgshw" height="50">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/selectLoanStudent" target="main">扫描添加</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx}/selectVisitorForm" target="main">借阅记录查询</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr> --%>
