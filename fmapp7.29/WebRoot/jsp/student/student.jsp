...
<head>
	...
	<link rel="stylesheet" href="/fmapp/css/partyinfo.css";type="t
...
<div id="mainwindow">
<table class="toptable" style="left:10%" width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  <!-- 查询区  -->
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="3" class="main_tab">
		    <tr>
			  <td class="fftd">
				    ...
				    <table width="80%" border="0" cellpadding="0" >
					  <tr>
					    ...
					    <td class="font3">
					    	...
					    	姓名：<input type="text" name="stname">
					    </td>
					    	<td>姓名：<input type="text" name="stname"></td>
					    	<td>学号：<input type="text" name="cardid"></td>
					  </tr>
					  <tr>
					    <td class="font3">
					    	专业：
					    	...
					    	班号：
					    		<select  name="clazznum_id" style="width:143px;">
								   ...
								   <c:forEach items="${requestScope.clazznums }" var="clazznum">
					    				<option value="${clazznum.id }">${clazznum.name }</option>
					    			</c:forEach>
								</select>&nbsp;
					    ...
					    <a href="${ctx}/addStudent?flag=1">添加本科生</a>&nbsp;&nbsp;
					    <a href="${ctx}/addPostgraduate?flag=1">添加研究生/博士</a>&nbsp;&nbsp;
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/selectStudent?pageIndex={0}&education_id=${student.education.id }&grade_id=${student.grade.id }&major_id=${student.major.id }&clazznum_id=${student.clazznum.id }"/>
	  </td></tr>
	</table>
